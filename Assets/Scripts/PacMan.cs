...
public class PacMan : MonoBehaviour{
    ...
    public RuntimeAnimatorController aliveAnimation;
    ...
    public void MoveToStartingPosition(){
        transform.GetComponent<Animator>().runtimeAnimatorController = aliveAnimation;
        ...
        if(obj != null){
            ...
            if(tile != null){
                if(!tile.didConsume && (tile.isPellet || tile.isSuperPellet)){
                    ...
                    //update score
                    GameBoard.score += 10;
                    GameObject.Find("Game").transform.GetComponent<GameBoard>().totalPelletsConsumed++;
